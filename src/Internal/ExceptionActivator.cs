...
public static class ExceptionActivator
{
    ...
    /// </summary>
    /// <typeparam name="TException">The type of the exception to create. Must inherit from <see cref="Exception"/>.</typeparam>
    /// <param name="args">An array of arguments to pass to the exception's constructor. Can be null or empty.</param>
    /// <returns>Returns an instance of the specified exception type <typeparamref name="TException"/>.</returns>
    /// <exception cref="InvalidOperationException">Thrown if the instance could not be created or if no matching constructor is found for the provided arguments.</exception>
